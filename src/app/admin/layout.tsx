...
function AdminLayoutFallback() {
  return (
    <div className="mx-auto w-full max-w-[128rem] flex-1 px-5 pb-20 pt-6 sm:px-8 lg:pt-10">
...
async function AdminShell({ children }: Readonly<{ children: React.ReactNode }>) {
  ...
  return (
    <div className="mx-auto grid w-full max-w-[128rem] flex-1 gap-6 px-5 pb-20 pt-6 sm:px-8 lg:grid-cols-[13.5rem_minmax(0,1fr)] lg:gap-10 lg:pt-10 xl:gap-12">
